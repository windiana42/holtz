...
namespace zertz
{
  namespace BGP
  {
    ...
    enum Ruleset_Type
    {
      ...
      ruleset_custom		// ruleset_custom <start_board> <common_stones> <win_condition>
    ...
    enum Common_Stones_Type
    {
      ...
      stones_custom		// stones_custom <white_stones> <grey_stones> <black_stones>
    };
